...
# ESTA CONSULTA PERMITE VISUALIZAR CUANTOS REGISTROS FUERON INSERTADOS
#print("Se intertaron ", mycursor.rowcount, " registros")


# ESTA CONSULTA PERMITE OBTENER TODOS LOS REGISTROS DE LA TABLA "personas"
#mycursor.execute("SELECT * FROM personas")

#data = mycursor.fetchall()

# MOSTRAMOS TODA LOS REGISTROS OBTENIDOS
#print(data)

# MOSTRAR VALORES ESPECIFICAS
#for dat in data:
#  print(f"Nombre y apellido: {dat[1]} {dat[2]}")
